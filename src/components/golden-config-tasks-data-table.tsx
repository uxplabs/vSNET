...
export const GOLDEN_CONFIG_TASKS_DATA: GoldenConfigTaskRow[] = [
  ...
  { id: '10', deviceType: 'MA3000', description: 'MA3000 head-end unit configuration', technology: 'LTE', imageConstraint: '>=1.0.4', lastUpdate: '2026-01-25', passCount: 5, failCount: 10, skippedCount: 5, lastRunDate: '2026-02-01', disabled: true },
  ...
  { id: '18', deviceType: 'MA3000', description: 'MA3000 remote unit RF parameters', technology: 'LTE', imageConstraint: '>=1.0.2', lastUpdate: '2026-01-20', passCount: 14, failCount: 0, skippedCount: 0, lastRunDate: '2026-01-31' },
